    ...
    function handleMessage(event) {
        ...
        if (event.source === parent) {
            ...
            case "connectWebsocket":
                var url = event.data.substring(actionIndex + 1, event.data.length);
                ...
                webSocket.onmessage = function(msg) {
                    ...
                    var msgEventStr = JSON.stringify(msgEvent);
                    parent.postMessage("websocketMsg;" + msgEventStr, "*");
                ...
                webSocket.onclose = function(event) {
                    ...
                    var closeEventStr = JSON.stringify(closeEvent);
                    parent.postMessage("websocketClosed;" + closeEventStr, "*");
                }
            ...
            case "websocketSend":
                var data = event.data.substring(actionIndex + 1, event.data.length);
                webSocket.send(data);
                break
