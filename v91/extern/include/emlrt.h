 ...
 */
#define EMLRT_VERSION_R2016B 0x2016B
#define EMLRT_VERSION_INFO  EMLRT_VERSION_R2016B
...
/*
* MATLAB INTERNAL USE ONLY :: Set the value of a property propName of a class instance mxArray mxClass.
*/
EXTERN_C LIBEMLRT_API const mxArray *emlrtSetProperty(const mxArray *mxClass, const mxArray *mxProp, const char *propName, int index);

/*
* MATLAB INTERNAL USE ONLY :: Get the value of a property propName of a class instance mxArray mxCls, given index.
*/
EXTERN_C LIBEMLRT_API const mxArray *emlrtGetProperty(emlrtConstCTX aTLS, const mxArray *mxCls, int aIndex, const char *propName);
...
/*
* MATLAB INTERNAL USE ONLY :: Check the class of an mxArray pa to be aClassName, otherwise error out using aMsgId and aTLS.
*/
EXTERN_C LIBEMLRT_API void emlrtCheckClass2016b(emlrtConstCTX aTLS, const emlrtMsgIdentifier *aMsgId, 
